package microservice.bootstrap;
...
import microservice.repositories.TicketRepository;
...
public class BugtrackerApplicationLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        Ticket tick8 = new Ticket("App8: Updates are not saved correctly to task name", "B URGENT: This is a bug impacting this feature in production", 1, 7);
        ...
        Ticket tick14 = new Ticket("App14: Updates are not saved correctly to task name", "C URGENT: This is a bug impacting this feature in production", 1, 13);
        Ticket tick15 = new Ticket("App15: Provide a list of applications for users", "The users need this new feature", 2, 13);
        Ticket tick16 = new Ticket("App16: Provide a list of tickets for an application", "The users need this new feature", 2, 15);
        Ticket tick17 = new Ticket("App17: Provide a list of tickets for a given release", "The users need this new feature", 3, 4);
        Ticket tick18 = new Ticket("App18: Give user the ability to add tickets to a release", "The users need this new feature", 4, 7);
        ...
        Ticket tick22 = new Ticket("App22: Provide a list of tickets for an application", "The users need this new feature", 2, 13);
        Ticket tick23 = new Ticket("App23: Provide a list of tickets for a given release", "The users need this new feature", 3, 14);
        Ticket tick24 = new Ticket("App24: Give user the ability to add tickets to a release", "The users need this new feature", 4, 15);
        Ticket tick25 = new Ticket("App25: Add the ability to sort by release date", "D URGENT: The users need this new feature", 1, 20);
        ...
        Ticket tick28 = new Ticket("App28: Provide a list of tickets for an application", "The users need this new feature", 2, 15);
        Ticket tick29 = new Ticket("App29: Provide a list of tickets for a given release", "The users need this new feature", 3, 13);
